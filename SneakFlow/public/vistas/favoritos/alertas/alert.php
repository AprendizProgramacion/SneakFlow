...
<?php if ($mostrarPopup): ?>
    ...
    <div id="popup">
        <div class="popup-container">
            ...
            <p class="popup-title">¡Atención, Aventurero!</p>
            <p class="popup-message">¡Parece que estás tratando de acceder al carrito de compras! 😮 Pero, oh-oh, parece que necesitas una cuenta para continuar con la compra de tus zapatillas favoritas. ¡Regístrate ahora y asegura tus zapatos más deseados!</p>
